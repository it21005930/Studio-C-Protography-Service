...
<br>
<!-- End of header -->
<form action="./save_site_feedback.php" method="post">
<div class="card-container">

    <div class="main">

        <ul class="cards">
            <li class="cards_item border-2 text-center">
                <div class="card text-center">
                    <div class="mycontainer">

                        <div class="feedback" >
                            <h4>Is the first time you visit the website?</h4>
<br>
                            <div class="form-check">
                                <div class="round">
                                    <input type="checkbox" id="yes" name="ck" value="Yes" >
                                    <label for="yes"></label>

                                </div>

                                <label class="form-check-label" for="yes"  style="margin-left: 15px; margin-top: 15px">Yes</label>
                            </div>
                            <div class="form-check">
                                <div class="round">
                                    <input type="checkbox" id="no" name="ck" value="No" >
                                    <label for="no"></label>
                                </div>
                                <label class="form-check-label" for="no"  style="margin-left: 15px; margin-top: 15px">No</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <li class="cards_item border-2 text-center">
                <div class="card text-center">
                    <div class="mycontainer">
                        ...
                        <div class="feedback">
                            <h4>We would like your feedback to improve our service.</h4>
                            <div class="rating">
            ...
            <li class="cards_item border-2 text-center">
                <div class="card text-center">
                    <div class="mycontainer">
                        ...
                        <div class="feedback">
                            <h4>Please Select Your Feedback Category.</h4>
<br>
                            <div class="custom-select" style="width: 70%">
                                <select name="fcategory" class="">
                ...
                <div class="card text-center">
                    <div class="mycontainer">
                        ...
                        <div class="feedback">
                            ...
                            <h2 >Please Leave Your Feedback below</h2>

                            <textarea  placeholder="Please enter what do you think about us" rows="20" name="comment" id="comment_text" cols="40" class="ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true" required></textarea>
                        </div>
                    </div>
                </div>
            </li>
...
<br>
                            ...
                            </div><span class="text-mute">Customer Service</span><br>
                            <div class="star-rating">
                            ...
                            </div><span class="text-mute">Service as described</span><br>
                            <div class="star-rating">
                            ...
                            </div><span class="text-mute">How about your satisfaction</span><br>
                            <div class="star-rating">
                            ...
                            </div><span class="text-mute">Service Quality</span><br>
                            <div class="star-rating">
                            ...
                            </div><span class="text-mute">Buy again or Recommend</span><br>
