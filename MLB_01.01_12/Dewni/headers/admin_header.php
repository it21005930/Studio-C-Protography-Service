...
<div class="container">
	...
	<div class="container1">
		...
		<div style="padding-left: 10px">
			<a href="../Dinushka/admin_dash.php"><input class="btn" type="button" name="signin" value="Dashboard"></a>
		</div>
	</div>
	</div>
</div>
...
<div class="container1">
	<div>
		<ul class="menu">
			...
			<li class="menu"><a href="packages.php">Services</a></li>
			<li class="menu"><a href="../Oshini/about.html">About Us</a></li>
			<li class="menu"><a href="../Dinushka/Orders_list.php">Orders</a></li>
			<li class="menu"><a href="../Dinushka/editor_dash.php">Uploads</a></li>
		</ul>
	</div>
