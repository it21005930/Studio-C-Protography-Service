...
<div class="container">
	<div>
	<img class="logo" src="Dinushka/Images/Logo.png" width="200px">
	</div>
	...
	<div class="user">
	<img src="Dinushka/Images/user.jpg" width="150px" style="border-radius: 25px">
	<div class="container1">
		<div style="padding-right: 10px">
			<a href="Maleesha/login.php"><input class="btn" type="button" name="login" value="Log In"></a>
		</div>
		<div style="padding-left: 10px">
			<a href="Maleesha/signup.php"><input class="btn" type="button" name="signup" value="Sign Up"></a>
		</div>
	</div>
	</div>
</div>
...
<div class="container1">
	...
	<div>
	<form method="get" action="Dinushka/searchresults.php">
		<table border="0px">
		<tr>
